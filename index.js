...
bot.onText('🧑‍💻 Кто мы?', async (msg) => {
  await bot.sendMessage(chatId, 'https://t.me/shibashipping/683');
});
    ...
    const categoryId = await bot.sendMessage(
      ...
      'Выберите категорю\n\n1.Аксессуары\n2.Одежда\n3.Обувь/Пуховики',
      {
        reply_markup: {
          force_reply: true,
          // inline_keyboard: [
          //   // ['Аксессуары', 'Одежда', 'Обувь/Пуховики'],
          //   // ['Отмена'],
          //   [{ text: 'абв', callback_data: '123' }],
          // ],
          // keyboard: [['Отмена']],
        },
      }
